...
#       monkeypatch.setattr("minion_assistant.tools.web_search.DDGS", MockDDGS)
...
#   preventing minion-assistant from starting at all.
try:
...
class WebSearchTool(Tool):
    ...
    def schema(self) -> ToolSchema:
        ...
        # minion-assistant — we clamp manually in execute() for safety).
        return ToolSchema(
            name="web_search",
            description=(
                "Search the web using DuckDuckGo. Returns titles, URLs, and snippets. "
