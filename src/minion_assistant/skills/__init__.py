...
-------------------------------------
Global skills (``~/.minion-assistant/skills/``) are scanned first, then project
skills (``<cwd>/.minion-assistant/skills/``).  When the same name appears in both
