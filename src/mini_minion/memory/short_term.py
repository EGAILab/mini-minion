...
ID (e.g. ``"main"`` → ``~/.mini-minion/sessions/main.jsonl``).
...
class ShortTermMemory:
    ...
    def __init__(self, base_dir: Path) -> None:
        ...
        # parents=True handles the case where ~/.mini-minion itself doesn't exist yet.
    ...
    def _path(self, key: str) -> Path:
        ...
        Returns:
            Path: Full path to the JSONL file, e.g. ``/home/user/.mini-minion/sessions/main.jsonl``.
        """
