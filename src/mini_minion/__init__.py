"""mini-minion — a minimal multi-agent CLI assistant.
...
**Start here:** ``src/mini_minion/minion.py:main()`` is where execution begins.
See ``mini-minion-documents/10-codebase-reading-guide.md`` for a recommended
