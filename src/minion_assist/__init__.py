"""minion-assist — a minimal multi-agent CLI assistant.
...
**Start here:** ``src/minion_assist/minion.py:main()`` is where execution begins.
See ``minion-assist-documents/10-codebase-reading-guide.md`` for a recommended
