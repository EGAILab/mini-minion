...
-------------------------------------
Global skills (``~/.minion-assist/skills/``) are scanned first, then project
skills (``<cwd>/.minion-assist/skills/``).  When the same name appears in both
