...
#       monkeypatch.setattr("minion_assist.tools.web_search.DDGS", MockDDGS)
...
#   preventing minion-assist from starting at all.
try:
...
class WebSearchTool(Tool):
    ...
    def schema(self) -> ToolSchema:
        ...
        # minion-assist — we clamp manually in execute() for safety).
        return ToolSchema(
            name="web_search",
            description=(
                "Search the web using DuckDuckGo. Returns titles, URLs, and snippets. "
