...
def test_tool_round_limit_stops_loop():
    ...
    from minion_assist.agents.runner import _MAX_TOOL_ROUNDS  # noqa: PLC0415
...
def test_retry_on_transient_error():
    ...
    from minion_assist.providers.base import LLMResponse as R
...
def test_tool_completed_event_emitted_in_serial_path():
    ...
    from minion_assist.agents.events import ToolCompleted
