...
from minion_assist.tools.mcp import (
    ListMcpResourcesTool,
    McpStatusTool,
    McpToolAdapter,
    ReadMcpResourceTool,
)
from minion_assist.mcp.types import McpConnectionStatus, McpResourceInfo, McpToolInfo
...
class TestDefaultRegistryMcpIntegration:
    def test_mcp_tools_registered_when_manager_provided(self):
        ...
        from minion_assist.mcp.types import McpToolInfo
