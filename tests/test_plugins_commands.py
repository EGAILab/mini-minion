...
import mini_minion.commands as commands_module
from mini_minion.commands import register_plugin_command, CommandSpec
...
def test_load_command_handler_registers_command(tmp_path):
    ...
    from mini_minion.plugins import _load_command_handler
...
def test_load_manifest_commands_section(tmp_path):
    ...
    from mini_minion.plugins import _load_manifest
